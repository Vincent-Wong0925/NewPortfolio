        ...
        <div className="contactPage min-vh-100">
            <Container className="text-center my-5 p-5 shadow">
                ...
                <Row className="w-75 p-3 mx-auto" xs={3}>
                    ...
                    <Col>
                        <a href="https://github.com/Vincent-Wong0925" target="_blank" rel="noreferrer" className="text-dark">
                    ...
                    <Col>
                        <a href="https://www.linkedin.com/in/vincent-wong-a90b6b262" target="_blank" rel="noreferrer" className="text-dark">
